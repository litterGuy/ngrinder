				...
				<ul class="nav pull-right">
					...
					<li class="dropdown">
						<a data-toggle="dropdown" class="dropdown-toggle pointer-cursor"> ${(currentUser.userName)!}
                            <#if (currentUser.ownerUser)??>(${currentUser.ownerUser.userName})</#if><b
									class="caret"></b>
						</a>
						<ul class="dropdown-menu">
							...
							<li>
								<a href="https://github.com/naver/ngrinder/wiki/nGrinder-Recorder-Guide"
								   target="_blank"><@spring.message "navigator.dropDown.downloadRecorder"/></a>
							</li>
							<li class="divider"></li>
                            <@security.authorize access="hasRole('A')">
								<li>
